...
class Utility(commands.Cog):
    ...
    async def bothelp(self, ctx: commands.Context):
        ...
        embed.add_field(name="🔒 Security", value="`antinuke`, `whitelist`, `unwhitelist`, `whitelisted`, `extraowner`, `anti-bot`", inline=False)
        embed.add_field(name="🛠️ Moderation", value="`ban`, `unban`, `kick`, `timeout`, `unmute`, `purge`, `lock`, `unlock`, `hide`, `unhide`", inline=False)
        embed.add_field(name="👑 Roles", value="`giverole`, `removerole`, `staff`, `vip`, `friend`, `girl`, `roleall`", inline=False)
        embed.add_field(name="⚙️ Utility", value="`ping`, `serverinfo`, `userinfo`, `avatar`, `banner`, `uptime`, `membercount`, `say`", inline=False)
